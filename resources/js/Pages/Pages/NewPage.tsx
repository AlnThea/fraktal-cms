                    ...
                    <div className="flex items-center py-4 overflow-x-auto whitespace-nowrap text-xs">
                        ...
                        <div className={'ml-7'}>
                            <span className="text-gray-500 dark:text-gray-200">
                                <a href={route('pages.index')} title={'Back to Pages'}
                        ...
                        <div className={'hidden lg:flex'}>
                            ...
                            <span className="mx-1 lg:mx-3 text-gray-300">/</span>
                            <span className="mx-1 lg:mx-3 text-gray-300 dark:text-gray-300"> Page </span>
                            <span className="mx-1 lg:mx-3 text-gray-300">/</span>
                            <span
                                className="text-emerald-300 dark:text-gray-400 hover:text-emerald-600">{pageId ? 'Edit Page' : 'New Page'}</span>
                        </div>
                    </div>
